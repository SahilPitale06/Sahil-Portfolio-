          ...
          <BlurFade delay={BLUR_FADE_DELAY * 13}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                I've completed {DATA.projects.length}+ projects in AI and Machine Learning, 
                ocusing on real-world applications from sentiment analysis to document verification. 
                Each project demonstrates my commitment to advancing technology and solving complex problems.
                </p>
              </div>
            </div>
          </BlurFade>
